...
<div class="row">
    ...
    <div align="center" class="col-sm-12" style="font-size: 15px; font-family: sans-serif">
        ...
        <strong><?php echo "Showing [".$this->Custom->getSupplierCode($supplier_id)."] Hotels for WTB Country: [".$country_name."] & WTB City [".$city_name."] with Status = [FETCHED] or [CREATED]." ?></strong>
        </p>
    </div> 
