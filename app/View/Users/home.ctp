...
<?php echo $this->Form->end(); ?>
                ...
                <div class="col-sm-8 real-estate-blk">
                    ...
                    <ul class="top_ico_nav clearfix">
                        <li>
                            <a href="/silk/users/dashboard/id:1/channel:214/industry:6"><img src="/img/24.png" alt="Adminstration" title="Adminstration"><span class="menu_label">Adminstration</span><span>Global</span></a>
