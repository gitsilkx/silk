 ...
 */
   ...
   public function ConvertGMTToLocalTimezone($gmttime, $timezoneRequired) {
    ...
    public function getSupplierHotelSubmitCnt($country_id,$city_id,$supplier_id){
...
if($type == 'Hotel Edited')
{
		...
		'joins' => array(
                    ...
                    array(
                        ...
                        'type'  => 'INNER',
                        'foreignKey'    => false,
                        'conditions'    => array('TravelHotelLookup.id = TravelActionItem.hotel_id','TravelHotelLookup.country_id' => $country_id,'TravelHotelLookup.province_id' => $province_id,'TravelHotelLookup.city_id' => $city_id),
...
//Hotel Approved => APPROVER COUNT
if($type == 'Hotel Approved')
{
        return ClassRegistry::init('TravelActionItem')->find('count', array('fields' => array('id'),
		...
		'conditions' => array('TravelActionItem.created_by' => $user_id,'TravelActionItem.level_id' => $level_id,'TravelActionItem.type_id' => '2' OR '3' OR '5' OR '9' OR '10','TravelActionItem.next_action_by' => NULL,'date(TravelActionItem.created) BETWEEN ? AND ?' => array($sdate,$edate)));	 
}
 
//Mapping Submitted => OPERATOT COUNT
if($type == 'Mapping Submitted')
{
        return ClassRegistry::init('TravelActionItem')->find('count', array('fields' => array('id'),
		...
		'joins' => array(
                    ...
                    array(
                        ...
                        'type'  => 'INNER',
                        'foreignKey'    => false,
                        'conditions'    => array('TravelHotelRoomSupplier.id = TravelActionItem.hotel_supplier_id','TravelHotelRoomSupplier.country_id' => $country_id,'TravelHotelRoomSupplier.city_id' => $city_id),'TravelHotelRoomSupplier.supplier_id' => $supplier_id,
...
//Mapping Approved => APPROVER COUNT
if($type == 'Mapping Approved')
{
        return ClassRegistry::init('TravelActionItem')->find('count', array('fields' => array('id'),
