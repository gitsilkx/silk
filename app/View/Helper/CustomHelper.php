...
if($type == 'Mapping Submitted')
{
		...
		'joins' => array(
                    ...
                    array(
                        ...
                        'type'  => 'INNER',
                        'foreignKey'    => false,
                        'conditions'    => array('TravelHotelLookup.id = TravelActionItem.hotel_id','TravelActionItem.level_id' => '7','TravelActionItem.type_id' => '4', 'date(TravelActionItem.created) BETWEEN ? AND ?' => array($sdate,$edate)),
