        ...
        return ClassRegistry::init('TravelHotelLookup')->find('count', array('fields' => array('id'),
            'joins' => array(
                    array(
                        ...
                        'type'  => 'INNER',
                        'foreignKey'    => false,
                        'conditions'    => array('TravelHotelLookup.id = TravelHotelRoomSupplier.hotel_id','TravelHotelRoomSupplier.supplier_id' => $supplier_id,'TravelHotelRoomSupplier.hotel_supplier_status !=' => array('1','2','7')),
                        ),
                )                   
