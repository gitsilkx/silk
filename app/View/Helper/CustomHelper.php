        ...
        return ClassRegistry::init('TravelHotelLookup')->find('count', array('fields' => array('id'),
            'joins' => array(
                    array(
                        ...
                        'type'  => 'LEFT',
                        'foreignKey'    => false,
                        'conditions'    => array('NOT'=> array('TravelHotelRoomSupplier.hotel_supplier_status' => array('1','2','7')),'TravelHotelLookup.id = TravelHotelRoomSupplier.hotel_id'),
                        ),
                )                   
            ,'conditions' => array('TravelHotelLookup.status' => array('2','8'),'TravelHotelLookup.country_id' => $country_id,'TravelHotelLookup.city_id' => $city_id,'province_id !=' => '0',
             'TravelHotelLookup.suburb_id !=' => '0','TravelHotelLookup.area_id !=' => '0','TravelHotelLookup.chain_id !=' => '0','TravelHotelLookup.brand_id !=' => '0')));
